...
function MeetupItem(props) {
  const router = Object(router_["useRouter"])(); //to navigate meetupid
  ...
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(external_react_["Fragment"], {
    children: [/*#__PURE__*/Object(jsx_runtime_["jsxs"])(head_default.a, {
      children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("title", {
        ...
        name: "description",
        content: "Browse a huge listbog highly active React"
      })]
...
async function getStaticProps() {
  // data fetch from db-----------
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://Jihana:Jihaan%40123@cluster0.xi6vh.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
